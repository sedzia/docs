...
1. [Publications Create Base Response Body](#publications-create-base-response-body)
2. <table><thead><tr><th style="text-align:left">Attributes</th><th style="text-align:left">Description</th></tr></thead><tbody><tr><td style="text-align:left">vouchers<code>array</code></td><td style="text-align:left"><p>Contains the unique voucher codes that was assigned by Voucherify.</p></td></tr></tbody></table>
