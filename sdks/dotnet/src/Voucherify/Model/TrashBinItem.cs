...
namespace Voucherify.Model
{
    ...
    public partial class TrashBinItem : IValidatableObject
    {
        ...
        */
        ...
        /// <param name="resourceParentId">Unique identifier of the parent resource. For a voucher, it is a campaign ID, except for generic (standalone) voucherss. For an SKU, it is the product ID. It returns &#x60;null&#x60; for campaigns and base products..</param>
        ...
        */
        ...
        /// </summary>
        /// <value>Unique identifier of the parent resource. For a voucher, it is a campaign ID, except for generic (standalone) voucherss. For an SKU, it is the product ID. It returns &#x60;null&#x60; for campaigns and base products.</value>
        /*
