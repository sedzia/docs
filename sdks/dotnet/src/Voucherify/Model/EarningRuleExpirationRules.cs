...
namespace Voucherify.Model
{
    ...
    public partial class EarningRuleExpirationRules : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Type of period. Currently, only &#x60;MONTH&#x60; is allowed.</value>
        ...
        /// </summary>
        /// <value>Type of rounding of the expiration period.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <param name="periodType">Type of period. Currently, only &#x60;MONTH&#x60; is allowed..</param>
        /// <param name="periodValue">Value of the period..</param>
        /// <param name="roundingType">Type of rounding of the expiration period..</param>
        /// <param name="roundingValue">Value of rounding of the expiration period..</param>
        public EarningRuleExpirationRules(PeriodTypeEnum? periodType = default(PeriodTypeEnum?), int? periodValue = default(int?), RoundingTypeEnum? roundingType = default(RoundingTypeEnum?), int? roundingValue = default(int?))
        {
        ...
        /// </summary>
        /// <value>Value of rounding of the expiration period.</value>
